...
| Group-controlled visibility | ✅ Complete | Effective visibility follows `columnGroupShow` across the full ancestor path; group-hidden leaves are identified and excluded from visibility actions |
