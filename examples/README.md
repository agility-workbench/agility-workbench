# Examples have moved to the documentation site

The focused, feature-specific example catalog that used to live in this
directory is now part of the documentation site, where each topic pairs the
snippets with a live interactive grid and per-framework (core / React /
Angular) code tabs:
...
Run the site locally with `npm run docs:dev` from the repository root.
