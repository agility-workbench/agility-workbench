 ...
 *  4. `tooltipComponent` (React): "Region" shows a small rich card.
 *  5. Interactive tooltip (React): "Country" tooltip has a button you can hover into and click
...
// Path 4: a rich React tooltip component for the Region column.
...
// Path 5: an interactive React tooltip for the Country column (has a clickable button).
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 12, height: "100%" }}>
      <div style={{ fontSize: 13, color: "#6b7280", lineHeight: 1.5 }}>
        ...
        <span style={{ fontWeight: 700 }}>Notes</span> clips, so it auto-shows the full text on hover.{" "}
        <span style={{ fontWeight: 700 }}>Rep</span> uses <code>tooltipField</code> (email),{" "}
        <span style={{ fontWeight: 700 }}>Revenue</span> a <code>tooltipValueGetter</code>,{" "}
        <span style={{ fontWeight: 700 }}>Region</span> a custom React <code>tooltipComponent</code>, and{" "}
        <span style={{ fontWeight: 700 }}>Country</span> an interactive one with a clickable button.
