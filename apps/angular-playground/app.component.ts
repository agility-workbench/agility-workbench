...
import { BlankPivotDemoComponent } from "./blank-pivot-demo.component";
...
const PAGES = [
  ...
  { id: "indexedInsert", label: "Indexed row insertion" },
...
@Component({
  ...
  imports: [
    ...
    IndexedInsertDemoComponent,
    KitchenSinkDemoComponent,
    MenusDemoComponent,
    PinnedRowsDemoComponent,
    PivotDemoComponent,
    BlankPivotDemoComponent,
    SheetsDemoComponent,
